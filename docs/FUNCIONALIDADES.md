...
### 6. Sugestão de tasks por análise (✨ Suggest)
...
### 7. Enriquecimento de descrição (enrichMode)
...
### 15. Gate de verificação pós-run
...
2. Criar tasks manualmente, por template, via ✨ Suggest ou importando issues do GitHub.
